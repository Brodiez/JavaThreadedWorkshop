<!-- Coded By: Garret John & Brodie Zoschke
Functionality: Customer Information Modify -->

<%@page import = "java.sql.*, java.io.*" %>
<%
	/* Set the Variables with Session ID's  */
	String custFName = (String)session.getAttribute("fName");
	String custLName = (String)session.getAttribute("lName");
		
		/* Runs the SQL using defined variables to pull out information from Database */
		try
		{
			...
			if(rs.next())
			{
				...
				<div align="center">
					...
					<div id="body">
						...
						<form name='NewCustomerForm' method='post' action='Update_Customer'>
						<table width='600' border='0' aligh='center' cellpadding='0' cellspacing='5'>
						<tr>
						<caption>Customer Modification</caption>
						</tr>
						<tr>
						<td colspan='2'><h6><i>Required Fields Indicated With a *</i></h6></td>
						</tr>
						<tr>
						<td width='110'><div align='left'><b>*First Name:</b></div>
						</td>
						<td><div align='left'>
						<input name='CustFirstName' type='text' id='CustFirstName' value='<%=rs.getString(2)%>' DISABLED></div>
						</td>
						<%
...
%>
<!-- Script which enable text fields and buttons on the form  -->
<script>
